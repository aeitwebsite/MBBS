...
export default function AboutSection() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full min-h-screen bg-white">
      {/* LEFT - Tab Navigation */}
      <div className="w-full md:w-1/4 p-4 md:p-6 bg-gray-50 md:bg-white flex md:flex-col overflow-x-auto md:overflow-x-visible">
        {["academic", "rules", "facilities", "committees"].map((k) => (
          <button
            key={k}
            onClick={() => handleTabChange(k)}
            className={`flex-shrink-0 md:w-full text-center md:text-left px-4 py-3 md:py-4 mr-2 md:mr-0 mb-0 md:mb-3 rounded-xl font-semibold transition-colors ${
              activeTab === k ? "bg-blue-600 text-white" : "bg-white md:bg-gray-50 text-gray-700"
            }`}
          >
