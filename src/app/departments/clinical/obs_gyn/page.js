...
export default function ObsGynPage() {
  const data = {
    ...
    faculties: [
      ...
      { name: "Dr. Hana Shetty", designation: "Assistant Professor", image: "/images/profile-pic/clinical/obs_gyn/Dr_Hana_Shetty.png", email: "", joiningDate: "", qualifications: "MBBS,MS", experience: "", interests: "", responsibilities: "", memberships: "" },
