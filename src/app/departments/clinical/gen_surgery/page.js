...
export default function GeneralSurgeryPage() {
  const data = {
    ...
    faculties: [
      ...
      { name: "Dr. Vinay Alva", designation: "Senior Resident", image: "", email: "", joiningDate: "", qualifications: "MBBS,MS", experience: "", interests: "", responsibilities: "", memberships: "" }, ///images/profile-pic/clinical/gen_surgery/Dr_Vinay_Alva.png
