  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        {/* ================= CONTENT AREA ================= */}
        <div className="w-full md:w-[77%] lg:w-[80%] p-4 sm:p-6 md:p-12 lg:p-16 overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 px-2">
                {committees.map((c) => (
                  <button
                    ...
                    className="flex justify-between items-center bg-[#04044a] p-5 sm:p-6 md:p-8 text-white rounded-lg hover:bg-blue-900 transition-colors"
                  >
                    <span className="text-base sm:text-lg md:text-xl font-semibold text-left pr-2 break-words">
                      {c.name}
                    </span>
                    <span className="bg-white text-black px-2 sm:px-3 py-1 rounded text-xs sm:text-sm font-bold flex-shrink-0">
                      VIEW
                    </span>
                  </button>
                ))}
          ...
          {activeTab === "academic" && (
            <div className="text-left text-gray-800 animate-fadeIn space-y-6 md:space-y-8 px-2 md:px-0">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-[#04044a] border-b-2 border-blue-100 pb-2 inline-block">Academics</h2>

              <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <p className="text-base md:text-lg mb-6 leading-relaxed text-gray-600 break-words">
                ...
                <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#04044a] flex items-center">
                  <span className="bg-blue-100 p-2 rounded-lg mr-3 shadow-sm text-lg md:text-xl">🎓</span> Our Programs
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 mt-4 md:mt-6">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-5 md:p-6 rounded-xl border border-blue-100 hover:-translate-y-1 transition-transform duration-300 text-center shadow-sm hover:shadow-md">
                    <div className="text-3xl md:text-4xl mb-3 md:mb-4">👨‍⚕️</div>
                    <h4 className="font-bold text-[#04044a] text-base md:text-lg mb-2">Undergraduate (MBBS)</h4>
                    <p className="text-xs md:text-sm text-gray-600">A comprehensive 5.5-year program including a 1-year mandatory rotating internship.</p>
                  </div>

                </div>

                <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#04044a] flex items-center mt-6 md:mt-8">
                  <span className="bg-green-100 p-2 rounded-lg mr-3 shadow-sm text-lg md:text-xl">📚</span> Learning Pedagogy
                </h3>
                <div className="bg-gray-50 p-5 md:p-6 rounded-xl border-l-4 border-[#04044a] shadow-inner mt-4 md:mt-6">
                  <p className="text-sm md:text-md leading-relaxed text-gray-700 break-words">
          ...
          {activeTab === "rules" && (
            <div className="text-left text-gray-800 animate-fadeIn px-2 md:px-0">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-[#04044a] border-b-2 border-blue-100 pb-2 inline-block">Rules and Regulations</h2>

              <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl shadow-lg border border-gray-100">
                <p className="text-base md:text-lg mb-6 md:mb-8 leading-relaxed text-gray-600 break-words">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div className="group bg-white p-5 md:p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-base md:text-lg text-[#04044a] mb-1 md:mb-2">Anti-Ragging Policy</h4>
                        <p className="text-xs md:text-sm text-gray-600">We enforce a strict zero-tolerance policy towards ragging in any form. Offenders will face immediate suspension and legal action as per UGC/NMC guidelines.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group bg-white p-5 md:p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-base md:text-lg text-[#04044a] mb-1 md:mb-2">Attendance Mandatory</h4>
                        <p className="text-xs md:text-sm text-gray-600">A minimum of 75% attendance in theory classes and 80% in clinical/practical sessions is strictly required to be eligible for university examinations.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group bg-white p-5 md:p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-base md:text-lg text-[#04044a] mb-1 md:mb-2">Dress Code & ID Cards</h4>
                        <p className="text-xs md:text-sm text-gray-600">Students must adhere to the formal dress code. Clean white aprons and valid college ID cards must be worn at all times within the college and hospital premises.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group bg-white p-5 md:p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-blue-300 transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-base md:text-lg text-[#04044a] mb-1 md:mb-2">Campus Discipline</h4>
                        <p className="text-xs md:text-sm text-gray-600">Use of mobile phones is restricted during teaching hours. Smoking, consumption of alcohol, or any illicit substances is strictly prohibited on campus.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === "facilities" && (
            <div className="text-left text-gray-800 animate-fadeIn space-y-6 md:space-y-8 px-2 md:px-0">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-[#04044a] border-b-2 border-blue-100 pb-2 inline-block">Campus Facilities</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">

                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-blue-50 rounded-2xl flex items-center justify-center text-2xl md:text-3xl mb-3 md:mb-4 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    🏛️
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-[#04044a]">Central Library</h3>
                  <p className="text-xs md:text-sm text-gray-600">A fully air-conditioned, 24/7 central library with a vast collection of national and international medical books, journals, and e-resources to support research and learning.</p>
                </div>

                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-teal-50 rounded-2xl flex items-center justify-center text-2xl md:text-3xl mb-3 md:mb-4 group-hover:bg-teal-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    🔬
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-[#04044a]">Skill Labs & Museums</h3>
                  <p className="text-xs md:text-sm text-gray-600">State-of-the-art simulation centers and clinical skill labs equipped with advanced mannequins. Departmental museums offer excellent pathology and anatomy specimens.</p>
                </div>

                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-orange-50 rounded-2xl flex items-center justify-center text-2xl md:text-3xl mb-3 md:mb-4 group-hover:bg-orange-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    🛏️
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-[#04044a]">Hostel & Mess</h3>
                  <p className="text-xs md:text-sm text-gray-600">Separate, secure, and well-furnished hostels for boys and girls within the campus. The mess provides hygienic, nutritious, and balanced meals tailored for student needs.</p>
                </div>

                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-red-50 rounded-2xl flex items-center justify-center text-2xl md:text-3xl mb-3 md:mb-4 group-hover:bg-red-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    🏥
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-[#04044a]">Teaching Hospital</h3>
                  <p className="text-xs md:text-sm text-gray-600">An attached multi-specialty hospital with high patient footfall, modern OTs, and ICUs, ensuring excellent practical and clinical exposure for our students.</p>
                </div>

                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-green-50 rounded-2xl flex items-center justify-center text-2xl md:text-3xl mb-3 md:mb-4 group-hover:bg-green-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    ⚽
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-[#04044a]">Sports & Recreation</h3>
                  <p className="text-xs md:text-sm text-gray-600">Expansive playgrounds for outdoor sports (cricket, football), indoor game facilities, and a fully equipped gymnasium to promote physical fitness and well-being.</p>
                </div>

                <div className="bg-white p-5 md:p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-300 border border-gray-100 group">
                  <div className="w-12 h-12 md:w-14 md:h-14 bg-purple-50 rounded-2xl flex items-center justify-center text-2xl md:text-3xl mb-3 md:mb-4 group-hover:bg-purple-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                    🤝
                  </div>
                  <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-[#04044a]">Student Support</h3>
                  <p className="text-xs md:text-sm text-gray-600">Dedicated student counseling center, round-the-clock campus security, ATM facilities, cafeteria, and a student healthcare clinic offering free medical aid.</p>
                </div>
          ...
          {activeTab !== "committees" && (
            <div className="text-center py-10 md:py-20">
              <h3 className="text-xl md:text-2xl font-bold text-gray-400"></h3>
            </div>
          )}
        </div>
      </div>
